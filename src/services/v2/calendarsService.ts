...
export class CalendarsService {
  ...
  async setCalendarSubscription(params: V2BodyParams): Promise<FoxApiResult> {
    const { token, siteId, query, body, cancelId } = params;
