...
export class ScheduleRecurrencesService {
  ...
  async listScheduleRecurrences(params: V2BaseParams): Promise<FoxApiResult> {
  ...
  async getScheduleRecurrence(params: V2BaseParams): Promise<FoxApiResult> {
    const { token, siteId, query, cancelId } = params;
  ...
  async createScheduleRecurrence(params: V2BodyParams): Promise<FoxApiResult> {
  ...
  async patchScheduleRecurrence(params: V2BodyParams): Promise<FoxApiResult> {
    const { token, siteId, query, body, cancelId } = params;
  ...
  async deleteScheduleRecurrence(params: V2BodyParams): Promise<FoxApiResult> {
    const { token, siteId, query, body, cancelId } = params;
