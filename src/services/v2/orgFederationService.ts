...
export class OrgFederationService {
  ...
  /** GET /orgFederation */
  async getOrgFederation(params: V2BaseParams): Promise<FoxApiResult> {
    const { token, siteId, query, cancelId } = params;
    return this.apiClient.get(v2Path(siteId, "/orgFederation", query), { header: authHeader(token), cancelId });
  }

  /** POST /orgFederation */
  async createOrgFederation(params: V2BodyParams): Promise<FoxApiResult> {
  ...
  async deleteOrgFederation(params: V2BodyParams): Promise<FoxApiResult> {
    const { token, siteId, query, body, cancelId } = params;
  ...
  async listOrgFederationInvites(params: V2BaseParams): Promise<FoxApiResult> {
    const { token, siteId, query, cancelId } = params;
  ...
  async createOrgFederationInvite(params: V2BodyParams): Promise<FoxApiResult> {
    const { token, siteId, query, body, cancelId } = params;
  ...
  async deleteOrgFederationInvite(params: V2BodyParams): Promise<FoxApiResult> {
    const { token, siteId, query, body, cancelId } = params;
  ...
  async acceptOrgFederationInvite(params: V2BodyParams): Promise<FoxApiResult> {
    const { token, siteId, query, body, cancelId } = params;
  ...
  async rejectOrgFederationInvite(params: V2BodyParams): Promise<FoxApiResult> {
    const { token, siteId, query, body, cancelId } = params;
  ...
  async leaveOrgFederation(params: V2BodyParams): Promise<FoxApiResult> {
    const { token, siteId, query, body, cancelId } = params;
  ...
  async patchOrgFederationVisibility(params: V2BodyParams): Promise<FoxApiResult> {
    const { token, siteId, query, body, cancelId } = params;
  ...
  async listOrgFederationAudits(params: V2BaseParams): Promise<FoxApiResult> {
    const { token, siteId, query, cancelId } = params;
