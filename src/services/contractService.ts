...
export class ContractService {
  ...
  async addContract(params: { token: string; body: string; siteIndex: string; cancelId?: string }): Promise<FoxApiResult> {
  ...
  async addContractLog(params: { token: string; contractNo: string; body: string; cancelId?: string }): Promise<FoxApiResult> {
  ...
  async patchContract(params: { token: string; body: string; cancelId?: string }): Promise<FoxApiResult> {
  ...
  async patchContractLogByIndex(params: { token: string; index: string; body: string; cancelId?: string }): Promise<FoxApiResult> {
  ...
  async modifyContractState(params: { token: string; body: string; cancelId?: string }): Promise<FoxApiResult> {
    const { token, body, cancelId } = params;
